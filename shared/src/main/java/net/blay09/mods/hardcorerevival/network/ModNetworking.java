...
public class ModNetworking {
    public static void initialize(BalmNetworking networking) {
        ...
        networking.registerClientboundPacket(id("revival_success"), RevivalSuccessMessage.class, RevivalSuccessMessage::encode, RevivalSuccessMessage::decode, RevivalSuccessMessage::handle);
